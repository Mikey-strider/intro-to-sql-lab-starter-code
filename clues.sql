...
-- description has been traveling through Southern Europe. 
...
SELECT * FROM countrylanguages WHERE language LIKE 'Italian' ORDER BY percentage;
-- SMR
...
SELECT countries.code AS country, cities.name AS city
FROM countries
...
SELECT * FROM cities WHERE population = 91085;
-- Carmen Sandiego is in Santa Monica, California - United States